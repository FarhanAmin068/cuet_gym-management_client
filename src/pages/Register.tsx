...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await signOut(auth); // Sign out the user after account creation
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Join CUET Gym today</p>
          </div>
      ...
      <div className="hidden lg:block lg:w-1/2">
        <img
          ...
          src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
          alt="Gym Equipment"
        />
      </div>
    </div>
